<template>
    <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
        <div class="cursor-pointer mr-2" @click.stop.prevent="task.is_complete = !task.is_complete">
            <svg v-if="task.is_complete" class="h-5 w-5 text-green-600" viewBox="0 0 20 20" fill="none"
        ...
        <div class="w-full">
            <input v-model="task.label" ref="input" type="text" placeholder="Digite a sua tarefa"
        ...
        <div class="ml-auto flex items-center justify-center">
            <button class="focus:outline-none" @click.stop.prevent="deleteTask()">
